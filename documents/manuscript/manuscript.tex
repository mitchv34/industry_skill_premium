...
\input{../tables/labor_share_by_industry.tex}
...
\input{../tables/labor_share_heterogeneity.tex}
...
\input{../tables/correlations_matrix.tex}
...
\begin{table}[H]
 \begin{center}
 \input{../tables/estimation_elasticities_korv.tex}
...
\input{../tables/extreme_csc_industries.tex}
...
\input{../tables/fit_quality_summary.tex}

\input{../tables/best_worst_fit.tex}
...
\input{../tables/decomposition_summary}

\input{../tables/decomposition_by_industry}
...
This appendix contains the point estimates and the model fit for each industry.
 ...
 \input{../tables/params_ind_estimates.tex}
\end{landscape}
